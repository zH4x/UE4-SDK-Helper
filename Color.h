...
namespace SDK
{
	...
	static const FLinearColor Green(0, 1.f, 0, 1.f);
	static const FLinearColor DarkGreen(.0f, 0.39f, .0f, 1.f);
	...
	static const FLinearColor Blue(0,0,1.f,1.f);
	static const FLinearColor CadetBlue(.37f, .62f, .63f);

	static const FLinearColor GreenYellow(.68f, 1.f, 18.f);
	...
	static const FLinearColor LightPink(1.f, .71f, .76f);

	static const FLinearColor Brown(.65f, .16f, .16f);
	static const FLinearColor RosyBrown(.74f, .56f, .56f);
}